...
start = time.time()
chi2_grid_om_sig8, chi2_grid_om_w, chi2_grid_sig8_w = library.compute_grid_Chi2(omega_m0_vals,sigma8_0_vals,w_vals,w_min,w_max,sig8_min,sig8_max, om_min, om_max,H0_min,H0_max,rd_min,rd_max)
end = time.time()
